...
variable "container_image_tag" {
  type        = string
  description = "Container image tag. Supports dynamic tags like 'staging:abc123def456' or 'v1.0.0'"
  default     = "latest"
}
...
variable "parameter_store_password_name" {
  type        = string
  description = "The name of the parameter in Parameter Store containing the master password (e.g., /database/staging/password)"
  default     = null
}
